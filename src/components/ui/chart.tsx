  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-(--tc-radius-md) border-gradient-subtle bg-surface-elevated/95 p-2.5 text-xs elevation-2 shadow-xl backdrop-blur-md",
          className
        )}
      >
                  ...
                  <>
                    {itemConfig?.icon ? (
                      ...
                      !hideIndicator && (
                        <div
                          className={cn(
                            "shrink-0 rounded-[2px] border-(--border-subtle)",
                            {
