...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-(--bg-surface-modal) p-6 shadow-2xl transition ease-(--tc-ease-smooth) duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out [box-shadow:var(--surface-highlight)]",
  {
    variants: {
      side: {
