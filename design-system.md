...
11. **Efeitos Cosméticos e Refinamento Visual (Premium Layer):** Para garantir o acabamento sofisticado do Joinha DS, utilize a classe canônica de **Borda Gradiente Unificada (`.border-gradient-subtle`)** em componentes destacados (Cards, Modais, Containers). A borda é um stroke único de 1px direcionado por uma fonte de luz física global a 135º (com queda rápida de intensidade nas curvas tangentes e sombra sólida na base/direita). É estritamente proibido o uso de chanfros internos (`inset box-shadow`) sobrepostos a bordas. Para foco da marca, utilize `.brand-glow` exclusivamente em botões e cards de conversão. Obedeça a regra estrita: **"Efeitos visuais nunca devem competir com a leitura de dados nem comprometer o contraste WCAG 2.2."**
